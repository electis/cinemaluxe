...
//------------------------------------------------------------------------------------
$('#step-ltr-form-img-text-half-form').validate({
    onfocusout: false,
    onkeyup: false,
    rules: {
    },
...
$('#step-ltr-form-img-text-half-form').submit(function () {
    // submit the form
    //data area
    var data = [];
    ...
    if ($(this).valid()) {
        ...
        $.ajax({
            ...
            processData: false,
            success: function () {
                $('#step-ltr-form-img-text-half-form').find('[type=submit]').button('complete');
            },
            error: function () {
                $('#step-ltr-form-img-text-half-form').find('[type=submit]').button('reset');
            }
        });
    } else {
